...
import Doughnut from "../other/donutchart.component";

const WipChart = () => {
  const TopModel = () => {
    return (
      <>
        <div className="col-span-full xl:col-span-3 bg-white dark:bg-slate-800 shadow-sm rounded-sm border border-slate-200 dark:border-slate-700">
